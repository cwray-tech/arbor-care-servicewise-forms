(function () {
  ...
  function SubmitForm(page, success) {
    ...
    /*@begincap@*/ let viewState = document.querySelector("#saFormData");
    let saFormData = viewState.value;
    const urlVars = GetUrlVars();
    const submitData = JSON.parse(saFormData);
    const data = {
      request: {
        formTemplateId: "c9432ab1-eed8-4d12-8976-758d89ceb61c",
  ...
  function InitializeSubmit() {
    ...
    LoadSubmitButton(
      "SimpleMessage",
      "<div>Thanks for your interest in Arbor Care! We will be in touch with you shortly!<br><br><br><a href=&quot;http://www.facebook.com/arborcarewa&quot; rel=&quot;noopener noreferrer&quot; target=&quot;_blank&quot;>Like us on Facebook!</a></div>"
    );
  }
  ...
  function InitializeChecklistField() {
    ...
    for (var i = 0; i < choices.length; i++) {
      ...
      choice.onclick = function (data) {
        var radio = data.currentTarget.getElementsByClassName(
          "sa-checkboxBtn"
        )[0];
        getChoiceBtns(radio);
      };
